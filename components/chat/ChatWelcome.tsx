...
export function ChatWelcome() {
  ...
  return (
    <div className="mx-auto flex min-h-dvh w-full max-w-2xl flex-col justify-center px-4 py-12 sm:px-6">
      ...
      <div className="mt-4 flex flex-wrap justify-center gap-2">
        {SUGGESTIONS.map((suggestion) => (
          <button
            ...
            className="rounded-full border border-edge bg-surface px-3.5 py-2 text-sm text-ink-secondary transition-colors hover:border-accent/50 hover:text-ink"
          >
            {suggestion}
          </button>
        ))}
